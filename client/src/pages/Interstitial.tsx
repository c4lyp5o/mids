			...
			<div className="max-w-6xl mx-auto h-full flex flex-col justify-center">
				...
				<div className="text-center mb-12">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						Choose your destination to continue with your mosque management
						experience
					</p>
				</div>
				...
				<div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto w-full">
					...
					>
						<div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity duration-300" />
						<div className="relative z-10">
							...
							<p className="text-gray-600 mb-4">
								Access the main interface with prayer times, announcements, and
								community updates
							</p>
					...
					>
						<div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity duration-300" />
						<div className="relative z-10">
							...
							<p className="text-gray-600 mb-4">
								Configure mosque settings, manage accounts, and customize your
								experience
							</p>
				...
				<div className="text-center mt-12">
					<p className="text-sm text-gray-500">
						Mosque ID:{" "}
						<span className="font-mono text-gray-700">{mosqueId}</span>
					</p>
				</div>
			</div>
		</div>
